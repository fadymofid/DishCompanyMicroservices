...
public class DishResponseListener {
    ...
    @RabbitListener(queues = RabbitConfig.DISH_RESPONSE_QUEUE)
    public void handle(DishDTO dto) {
        dishResponseCache.put(dto.getId(), dto);
    }
    ...
    public DishDTO waitForDishResponse(Long id, long timeoutMillis) {
        long deadline = System.currentTimeMillis() + timeoutMillis;
        while (System.currentTimeMillis() < deadline) {
            DishDTO dto = dishResponseCache.remove(id);
