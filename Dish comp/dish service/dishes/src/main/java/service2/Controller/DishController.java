...
public class DishController {
    ...
    @GET
    @Path("/name/{id}")
    public String getNameById(@PathParam("id") int id) throws Exception {
        return dishService.getNameById(id);
    }


    // GET /internal/dish/{id}
    @GET
    @Path("/internal/dish/{id}")
    public Dish getDishInfoById(@PathParam("id") int id) throws Exception {
        return dishService.getDishById(id);  // Already available method
    }
